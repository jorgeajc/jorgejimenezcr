...
class ProgrammingLanguages extends Model
{
    ...
    public function level() {
        return $this->belongsToMany(Levels::class, 'users_programming_languages', 'programming_languages_id', 'level_id')->withPivot('user_id', 'programming_languages_id', 'level_id', 'percentage', 'year_experience', 'is_active');
    }
}
